...
contract ERC721Token is ERC721 {
    ...
    mapping(address => uint256) private ownerToTokenCount; // kitne nfts h is account ke voh mapping hai
    ...
    function _safeTransfer(
        ...
        if (_to.isContract()) {
            ...
            require(
                ...
                "Recpient smart contract cannot handle erc721 tokens"
            );
        }
    }
    ...
    modifier canTransfer(uint _tokenId){
        ...
        address _owner= idToOwner[_tokenId];
        require(_owner==msg.sender || idToApproved[_tokenId]==msg.sender || ownerToOperators[_owner][msg.sender]==true,"Not authorised");
        _;
    }
}
